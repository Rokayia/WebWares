<template>
  ...
  <div class="utilisation">
    ...
    <p>Dans l'Espace économique européen (EEE) et en Suisse, les services Google vous sont fournis par la société
      ci-dessous avec laquelle vous concluez un contrat :
    ...
    <br><br>
    <h2>Limite d'âge</h2>
    <p>Si vous n'avez pas atteint la limite d'âge pour gérer votre propre compte Google, vous devez avoir l'autorisation
      d'un parent ou d'un représentant légal pour utiliser un compte Google. Veuillez demander à un parent ou à un
      représentant légal de lire les présentes conditions avec vous.
      Si vous êtes un parent ou un représentant légal, et si vous autorisez votre enfant à utiliser les services, les
      présentes conditions s'appliquent à vous, et vous êtes responsable des activités de votre enfant sur ces services.
    ...
    <p>Les présentes conditions d'utilisation contribuent à déterminer la nature de votre relation avec Google. D'une
      manière générale, nous vous autorisons à utiliser nos services si vous acceptez de respecter ces conditions, qui
      reflètent le fonctionnement des activités de Google et la façon dont nous nous rémunérons. Par les termes "Google",
      "nous", "nos" et "notre", nous désignons Google Ireland Limited et ses sociétés affiliées.</p>
  </div>
  <br><br><br>
  <footerVue />
</template>
